...
// TODO: The desktop version of NVG has title and cursor. We should have
...
// Note: NVG has a notion of width and height on Group but AFAIK it's a noop in
// ReactNVG.
...
function extractBrush(colorOrBrush, props) {
  ...
  if (colorOrBrush._brush) {
    if (colorOrBrush._bb) {
      ...
      // deprecated. It's not properly implemented in canvas mode. ReactNVG
...
// Note: NVG has a notion of width and height on Shape but AFAIK it's a noop in
// ReactNVG.
...
function RadialGradient(stops, fx, fy, rx, ry, cx, cy) {
  ...
  // The NVG API expects the radial gradient to be repeated at the edges.
