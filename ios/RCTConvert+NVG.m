...
// This prepares everything for rendering a frame of text in NVGText.
+ (NVGTextFrame)NVGTextFrame:(id)json
{
  ...
  frame.lineHeight = size * 1.1; // Base on NVG canvas line height estimate
...
+ (NVGBrush *)NVGBrush:(id)json
{
  ...
  switch (type) {
    case 0: // solid color
      ...
      return [[NVGSolidColor alloc] initWithArray:arr];
    case 1: // linear gradient
      return [[NVGLinearGradient alloc] initWithArray:arr];
    case 2: // radial gradient
      return [[NVGRadialGradient alloc] initWithArray:arr];
    case 3: // pattern
      return [[NVGPattern alloc] initWithArray:arr];
    default:
...
+ (CGGradientRef)CGGradient:(id)json offset:(NSUInteger)offset
{
  ...
  NVGCGFloatArray colorsAndOffsets = [self NVGCGFloatArray:arr];
