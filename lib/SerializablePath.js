...
export default class SerializablePath {
    ...
    addRectangle = (x, y, w, h) => {
        this.path.push(RECTANGLE, x, y, w, h);
        return this;
    };

    addRoundedRectangle = (x, y, w, h, rTopLeft, rTopRight, rBottomRight, rBottomLeft) => {
        if(rTopRight === undefined)
            this.path.push(ROUNDED_RECTANGLE, x, y, w, h, rTopLeft, rTopLeft, rTopLeft, rTopLeft);
        else
            this.path.push(ROUNDED_RECTANGLE, x, y, w, h, rTopLeft, rTopRight, rBottomRight, rBottomLeft);
        return this;
    };
